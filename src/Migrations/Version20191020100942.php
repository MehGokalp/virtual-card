...
final class Version20191020100942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vendor (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(32) NOT NULL, bucket_limit INT NOT NULL, bucket_date_delta INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE currency (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(16) NOT NULL, code VARCHAR(4) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bucket (id INT AUTO_INCREMENT NOT NULL, currency_id INT NOT NULL, vendor_id INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, balance INT NOT NULL, INDEX IDX_E73F36A638248176 (currency_id), INDEX IDX_E73F36A6F603EE73 (vendor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE bucket ADD CONSTRAINT FK_E73F36A638248176 FOREIGN KEY (currency_id) REFERENCES currency (id)');
