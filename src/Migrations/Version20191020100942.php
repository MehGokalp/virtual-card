...
final class Version20191020100942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE virtual_card (id INT AUTO_INCREMENT NOT NULL, currency_id INT NOT NULL, vendor_id INT NOT NULL, balance INT NOT NULL, activation_date DATE NOT NULL, expire_date DATE NOT NULL, notes VARCHAR(2048) DEFAULT NULL, process_id VARCHAR(255) NOT NULL, reference VARCHAR(255) NOT NULL, card_number VARCHAR(255) NOT NULL, cvc VARCHAR(255) NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_FF9C85EB38248176 (currency_id), INDEX IDX_FF9C85EBF603EE73 (vendor_id), PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE bucket (id INT AUTO_INCREMENT NOT NULL, currency_id INT NOT NULL, vendor_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, balance INT NOT NULL, INDEX IDX_E73F36A638248176 (currency_id), INDEX IDX_E73F36A6F603EE73 (vendor_id), PRIMARY KEY(id))');
