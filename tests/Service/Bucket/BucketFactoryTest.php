...
class BucketFactoryTest extends WebTestCase
{
     ...
     */
    public function testValidCreate(int $bucketDateDelta, int $bucketLimit, string $currencyCode, string $startDate, string $endDate): void
    {
     ...
     * @throws ValidationException
     */
    public function testInvalidCreate(int $bucketDateDelta, int $bucketLimit, string $currencyCode, string $startDate, string $endDate): void
    {
        $vendor = $this->getVendor($bucketDateDelta, $bucketLimit);
        $currency = $this->getCurrency($currencyCode);
